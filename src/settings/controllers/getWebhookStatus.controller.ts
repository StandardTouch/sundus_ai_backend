...
export async function getWebhookStatusController(req: Request, res: Response): Promise<void> {
  try {
    const result = await settingsService.getSettingByKey("webhook_active");
